...
BitX.prototype.getTradeList = function (options, callback) {
  ...
  this._request('GET', 'listtrades', Object.assign(defaults, options), callback)
}
...
BitX.prototype.getFeeInfo = function (options, callback) {
  ...
  this._request('GET', 'fee_info', Object.assign(defaults, options), callback)
}
...
BitX.prototype.postBuyOrder = function (volume, price, options, callback) {
  ...
  this._request('POST', 'postorder', Object.assign(body, options), callback)
}
...
BitX.prototype.postMarketBuyOrder = function (volume, options, callback) {
  ...
  this._request('POST', 'marketorder', Object.assign(body, options), callback)
}
