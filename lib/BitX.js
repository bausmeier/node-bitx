...
BitX.prototype.getOrderBook = function(callback, pair) {
  this._request('GET', 'orderbook', {pair: this.pair}, callback);
};

BitX.prototype.getTrades = function(callback, pair) {
  this._request('GET', 'trades', {pair: this.pair}, callback);
};

BitX.prototype.getOrderList = function(callback, pair) {
  this._request('GET', 'listorders', {pair: this.pair}, callback);
};
...
BitX.prototype.getFundingAddress = function(asset, callback) {
  this._request('GET', 'funding_address', {asset: asset}, callback);
};
